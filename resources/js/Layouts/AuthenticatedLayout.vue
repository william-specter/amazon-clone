...
<template>
                ...
                <div class="flex items-stretch justify-center">
                    <div class="p-4 mx-auto text-center">
                        ...
                        <div class="flex justify-start">
                            <div class="w-full text-xs font-extrabold text-left text-red-600">$99.99</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div v-if="showMenu" class="fixed top-0 z-50 w-full h-full bg-black bg-opacity-70" :class="[showMenu ? 'animate__animated animate__fadeIn animate__faster' : '']">
        <CloseIcon @click="showMenu = false" :size="30" fillColor="#DCDCDC" class="ml-2.5 mt-3.5 left-80 cursor-pointer fixed z-50" :class="[showMenu ? 'animate__animated animate__fadeIn animate__faster' : '']" />
        <div class="h-full bg-white w-80" :class="[showMenu ? 'animate__animated animate__slideInLeft animate__faster' : '']">
            ...
            <div class="pl-6 pr-3 hover:bg-gray-200">
