...
<template>
    <div class="min-w-[1150px] bg-gray-900 h-full">
        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed z-50 min-w-[1150px] w-full">
            ...
            <div class="flex grow items-center h-[45px] px-1">
                <div class="flex items-center justify-center font-extrabold bg-gray-100 border-r-gray-300 text-[11px] text-gray-600 w-[60px] h-[40px] rounded-l-md cursor-pointer">
                    <div class="pt-[3px]">
                        All
                    </div>
                    <MenuDownIcon fillColor="#5E5E5E" :size="20" class="-mr-2" />
                </div>
                <input class="block w-full border-transparent border-none focus:border-transparent focus:ring-0" type="text">
                    ...
                    <div class="flex items-center justify-center">
                        <div>
                            ...
                            <div class="flex items-center">
                                <div class="text-[15px] text-white -mt-1.5 font-extrabold">Accoun & List</div>
                                <MenuDownIcon fillColor="#c2c2c2" :size="20" class="pr-1 -mt-1 -mr-4" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex">
                                <div class="w-1/2 border-r">
                                    <div class="pb-3">
                                        ...
                                        <div class="text-sm hover:text-red-600 hover:underline pt-3">Create the list</div>
                                    </div>
                                </div>
        ...
        <div class="flex items-center justify-between bg-[#232f3e] h-[38px] fixed z-40 min-w-[1150px] w-full mt-[60px]">
            <div class="flex">
                ...
                <div class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">William's Amazon.com</div>
                    </div>
                </div>
            </div>
            <div class="flex">
        ...
        <div class="w-full mt-10 overflow-x-scroll bg-white">
                    ...
                    <div v-for="product in $page.props.random_products" :key="product">
                        <div class="p-4 mx-auto text-center">
                            ...
                            <div class="flex justify-start">
                                <div class="w-full text-xs font-extrabold text-left text-red-600">${{ product.price }}</div>
    ...
    <div v-if="showMenu" class="fixed top-0 z-50 w-full h-full bg-black bg-opacity-70" :class="[showMenu ? 'animate__animated animate__fadeIn animate__faster' : '']">
        <CloseIcon @click="showMenu = false" :size="30" fillColor="#DCDCDC" class="-ml-8 mt-2 left-80 cursor-pointer fixed z-50" :class="[showMenu ? 'animate__animated animate__fadeIn animate__faster' : '']" />
        <div class="h-full bg-white w-80" :class="[showMenu ? 'animate__animated animate__slideInLeft animate__faster' : '']">
            ...
            <div v-for="cat in $page.props.categories" :key="cat">
                <Link href="/" class="pl-6 pr-3 hover:bg-gray-200">
